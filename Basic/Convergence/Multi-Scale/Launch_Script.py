...
for c,NR in enumerate(Number_Residuals):
	for i in range(NAttempts):
		Solver=Resolutor_ADAM_BFGS_Basic[Poisson_Scalar_Basic](1,Hidden_Layers,Neurons_Per_Layer,Sigma,Domain,NR,Number_Boundary_Points,Boundary_Labels,F_Multi,G,G)
		...
		Dictionary={'W': W,'Time': Elapsed,'History': History,'Relative_L2_Error': Relative_L2_Error,'DFT_Error': DFT_Error,'Freqs_DFT': Freqs,'Hidden_Layers': Hidden_Layers,
					'Neurons_Per_Layer': Neurons_Per_Layer,'Solution': String_Multi,'Network_Eval': Network_Eval,'Solution_Eval': Solution_Eval,'Batch_Size': ADAM_Batch[c]}
