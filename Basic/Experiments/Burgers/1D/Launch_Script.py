...
""" Launch Script For Burgers 1D [To Be Launched Once For Each Test] [To Be Tuned By Hand For Every Launch] """
...
Number_Boundary_Points=[[150,0],[100,100]]
		...
		for HL in Hidden_Layers:
			for NPL in Neurons_Per_Layer:
					for i in range(NAttempts):
						...
						Data={'Source': F,'Exact_Dirichlet': G,'Exact_Neumann': G,'Nu': 2.5e-3}
						Solver=Resolutor_Basic[Burgers_Scalar_Basic](Architecture,Domain,Data)
