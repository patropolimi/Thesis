...
""" Test 5 Launch Script -> Basic PINN Generic Sensitivity Analysis """


Negative_Slope=5*1e-2
def LeakyRelu(X):
...
Activations={'Tanh': jnp.tanh,'Relu': jax.nn.relu,'Silu': jax.nn.silu,'LeakyRelu': LeakyRelu}
